...
export const FORM_FIELD_SYNONYM_GRAPH: Record<string, string[]> = {
  ...
  'basics.nativePlace.city': ['籍贯', '生源地', '祖籍', '生源地所在省市', 'native place', 'origin'],
  'basics.birthPlace.city': ['出生地', '出生地点', '出生所在地', 'place of birth', 'birth place'],
  'basics.hukouLocation.city': ['户口所在地', '户籍所在地', '户口地', '户籍地址', 'registered residence', 'hukou'],
  ...
  'basics.hobbies': ['兴趣爱好', '个人爱好', '兴趣及特长', '爱好特长', 'hobbies', 'interests'],
